...
<form class="delete-form" action="{{ route('pembina.destroy', $id) }}" method="POST">
    @csrf
    @method('DELETE')
    <div class="d-flex gap-3">

        @if (Auth::user()->roles == 'Administrator')
            <a href="{{ route('pembina.edit', $id) }}" class="text-success"><i class="mdi mdi-pencil font-size-18"></i></a>
