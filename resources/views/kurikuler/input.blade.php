...
@section('evoting')
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form class="needs-validation" action="{{ route('kegiatan.store') }}" method="POST" novalidate>
                @csrf
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="nama" name="nama"
                                                maxlength="30" autofocus required placeholder="Nama Kegiatan">
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control" id="deskripsi" name="deskripsi"
                                                autofocus maxlength="30" placeholder="Deskripsi">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="mb-3">
